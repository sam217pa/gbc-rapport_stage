...
\afterpage{%
  ...
  \caption[Mécanismes moléculaires de conversion génique]{\textbf{Mécanismes de
    ...
    de transformation.
    \\
    Lors d'une cassure double brin (\textsf{b}), l'extrémité de la cassure subit
    une résection, qui est réparée sur la base d'une matrice d'ADN homologue
...
% TODO revoir la conclusion de l'intro
