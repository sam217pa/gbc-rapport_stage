...
l'action du gBGC. % Les codons optimaux correspondant aux codons les
% plus représentés dans les gènes fortement transcrits, ils disposent d'un
% stock d'ARN de transfert adéquat.  TODO référence sur l'usage du code et les
% codons optimaux