\begin{center}
  ...
  \begin{tikzpicture}[line width = 2pt, join = round, scale = 0.8]
    ...
    \begin{scope}
      ...
      \draw[Gray, densely dotted, thin] [->] (4, -0.5) node[left , font=\tiny] {Homologues} -- ++(1, 0)  -- ++(0.5, +0.4);
      \draw[Gray, densely dotted, thin] [->] (4, -0.5) -- ++(1, 0) -- ++(0.5, -0.4);
      \draw[Gray, densely dotted, thin] [->] (4, -0.5) -- ++(4, 0) -- ++(0.5, +0.4);
      \draw[Gray, densely dotted, thin] [->] (4, -0.5) -- ++(4, 0) -- ++(0.5, -0.4);
