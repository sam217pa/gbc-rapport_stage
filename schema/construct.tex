\begin{center}
  ...
  \tikzset{
    plasmid/.pic={
	    \draw[Green, plasmid lines, thick] (3, -1) rectangle (11, 0);
  ...
  \begin{tikzpicture}[scale=0.7, line width = 2pt, join=round]
    ...
    \begin{scope}[shift={(-5, -2)}]
      ...
      \draw[Green, thick] (10, 0) -- (12, 0) node[font = \tiny, above, align = right] {Consruction \\ plasmidique};
      ...
      \draw[SteelBlue1, thick] (8.8, -1) -- (12, -1) node[font=\tiny, below, align = right] {Génome \\ \emph{Acinetobacter}};
      %amorces
      \draw[Red3, ultra thick] (4, -1) -- (4.2, -1);
