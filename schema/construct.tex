\begin{center}
  ...
  \definecolor{plasmid_col   }{rgb}{255, 127, 0   }
  \definecolor{gs_don_col    }{rgb}{31,  120, 180 }
  \definecolor{gs_rec_col    }{rgb}{251, 154, 153 }
  \definecolor{am1_col       }{rgb}{253, 191, 111 }
  \definecolor{kanr_col      }{rgb}{106, 61,  154 }
  \definecolor{am2_col       }{rgb}{202, 178, 214 }
  \definecolor{ancre_don_col }{rgb}{51,  160, 44  }
  \definecolor{ancre_rec_col }{rgb}{178, 223, 138 }
  \definecolor{am3_col       }{rgb}{255, 255, 153 }
  \definecolor{genome_col    }{rgb}{177, 89,  40  }
  % \definecolor{receveurcol}
  % \definecolor{kanrcol}
  % \definecolor{ancrecol}
  ...
  \begin{tikzpicture}[scale=0.7, line width = 2pt, join=round]
    ...
    \begin{scope}[shift={(-5, -2)}]
      ...
      \draw[Cerulean, thin, dotted] (4, 0) -- (5, -1);
      \draw[Cerulean, thin, dotted] (6, 0) -- (7, -1);
      \draw[Orange1,  thin, dotted] (8, 0) -- (7, -1);
      \draw[Orange1,  thin, dotted] (9.8, 0) -- (8.8, -1);
      ...
      \draw[ Orange1, very thick] (8.8, -3.7) -- ++(-0.5, 0) -- ++(-0.2, -0.6) -- ++(-0.7, 0);
      ...
      \draw[Orange1, very thick]                     (8.8, -4.6) -- ++(-2, 0);
      \draw[SteelBlue1, very thick]                  (6.8, -4.6) -- ++(-0.2, 0);
      \draw[Orchid3, very thick]                     (6.6, -4.6) -- ++(-2, 0);
      \draw[Gold1, very thick]                       (4.6, -4.6) -- ++(-0.2, 0);
      \draw[Cerulean, very thick]                    (4.4, -4.6) -- ++(-2, 0);
      \draw[Green, thick]                            (2.4, -4.6) -- ++(-0.4, 0);
      \draw[Green, thick, arrows = {-Stealth[left]}] (8.8, -4.6) -- ++(2, 0);
      ...
      \draw[densely dotted, Orange1, very thick]    (7.35, -4.3) --  (6.8, -4.3);
      \draw[densely dotted, SteelBlue1, very thick] (6.8, -4.3) -- ++(-0.2, 0);
      \draw[densely dotted, Orchid3, very thick]    (6.6, -4.3) -- ++(-2, 0);
      \draw[densely dotted, Gold1, very thick]      (4.6, -4.3) -- ++(-0.2, 0);
      \draw[densely dotted, Cerulean, very thick, arrows = {-Stealth[left, scale = 0.5]}]   (4.4, -4.3) -- ++(-1.5, 0);
      %% lignes permettant de montrer l'appariemment des régions
      \draw[Cerulean, thin, dotted ] (2.9, -4.3) -- (5, -3.5);
      \draw[Cerulean, thin, dotted ] (4.4, -4.3) -- (7, -3.5);
      ...
      % brin ->
      \draw[Cerulean, arrows = {-Stealth[left, scale = 1]}, very thick] (5, -6) -- (7, -6);
      \draw[Orange1, very thick] (11.4, -6) -- ++(-0.5, 0);
      \draw[SteelBlue1, thick, arrows = {-Stealth[left]}] (11.4, -6) -- ++(1, 0);
      % \draw[Orange1] (8.3, -6) -- (8.8, -6);
      \draw[SteelBlue1, thick] (2, -6) -- (5, -6);
      %% brin <-
      % petit bout bleu
      \draw[Cerulean, ultra thick]                        (5, -6.2)   --   (5.5, -6.2);
      \draw[Cerulean, densely dotted, very thick, arrows = {Stealth[left, scale = 0.5]-}] (6.0, -6.2) -- ++(1.0, 0);
      \draw[densely dotted, Gold1, very thick]            (7.0, -6.2) -- ++(0.2, 0);
      \draw[densely dotted, Orchid3, very thick]          (7.2, -6.2) -- ++(2.0, 0);
      \draw[densely dotted, SteelBlue1, very thick]       (9.2, -6.2) -- ++(0.2, 0);
      \draw[densely dotted, Orange1, very thick]          (9.4, -6.2) --   (9.9, -6.2);
      \draw[solid, Orange1, very thick]                   (9.9, -6.2) -- ++(1.5, 0);
      % génome
      \draw[SteelBlue1, thick]                            (11.4, -6.2) -- ++(1, 0);
      \draw[SteelBlue1, thick, arrows = {Stealth[left]-}] (2, -6.2) --      (5, -6.2);

      %%
      %% SYNTHÈSE DU BRIN 5'
      %%
      \draw[Gray] [->] (7, -6.5) -- ++(0, -1) node[midway, left, legende] {Synthèse du brin \(5'\) };

      %% brin ->
      \draw[Cerulean, arrows = {-Stealth[left, scale = 1]}, very thick]
      (5, -8.0) -- (7, -8.0);
      \draw[Orange1, very thick]
      (11.4, -8.0) -- ++(-0.5, 0);
      \draw[SteelBlue1, thick, arrows = {-Stealth[left]}]
      (11.4, -8.0) -- ++(1, 0);
      \draw[SteelBlue1, thick]
      (2, -8.0) -- (5, -8.0);
      \draw[densely dotted, Gold1, very thick]
      (7.0, -8.0) -- ++(0.2, 0);
      \draw[densely dotted, Orchid3, very thick]
      (7.2, -8.0) -- ++(2.0, 0);
      \draw[densely dotted, SteelBlue1, very thick]
      (9.2, -8.0) -- ++(0.2, 0);
      \draw[densely dotted, Orange1, very thick]
      (9.4, -8.0) -- ++(1.5, 0);

      %% brin <-
      \draw[Cerulean, ultra thick]
      (5, -8.2)   --   (5.5, -8.2);
      \draw[Cerulean, solid, very thick]
      (6.0, -8.2) -- ++(1.0, 0);
      \draw[Cerulean, densely dotted, very thick, arrows = {-Stealth[left, scale = 0.5]}]
      (6.0, -8.2) -- ++(-0.5, 0);
      \draw[solid, Gold1, very thick]
      (7.0, -8.2) -- ++(0.2, 0);
      \draw[solid, Orchid3, very thick]
      (7.2, -8.2) -- ++(2.0, 0);
      \draw[solid, SteelBlue1, very thick]
      (9.2, -8.2) -- ++(0.2, 0);
      \draw[solid, Orange1, very thick]
      (9.4, -8.2) --   (9.9, -8.2);
      \draw[solid, Orange1, very thick]
      (9.9, -8.2) -- ++(1.5, 0);
      % génome
