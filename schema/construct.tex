\begin{center}
	...
	\begin{scope}[shift={(-0.3, 10)}]
	    ...
	    \draw[Green] (0.1, 0.3) node {\tiny T};
	    \draw[Green] (1.7, 0.3) node {\tiny T};
	\end{scope}
	...
	\begin{scope}[shift={(-5, 4)}]
	    ...
	    \draw[Green] (0, 0) -- (4, 0) node[auto, above, midway] {\tiny \texttt{pGEM-T}};
	    \draw[Cerulean] (4, 0) -- (6, 0) node [auto, above, midway] {\tiny \texttt{Gène Synthétique}};
	    \draw[Gold1] (6, 0) -- (6.2, 0);

	    \draw[Gold1] (6, 0.6) -- (6.2, 0.6);
	    \draw[Orchid3] (6.2, 0.6) -- (7.8, 0.6) node[auto, above, midway] {\tiny \texttt{KanR}};
	    \draw[SteelBlue1] (7.8, 0.6) -- (8.0, 0.6);

	    \draw[SteelBlue1] (7.8, 1.0) -- (8.0, 1.0);
	    \draw[Orange1] (8.0, 1.0) -- (9.8, 1.0) node[auto, above, midway] {\tiny \texttt{Ancre}};
