\begin{center}
  ...
  \begin{tikzpicture}[scale=0.7, line width = 2pt, join=round]
    ...
    \begin{scope}[shift={(-5, -2)}]
      ...
      \draw[Green, thick] (10, 0) -- (12, 0) node[font = \tiny, above, align = right] {Construction \\ plasmidique};
      ...
      \draw[SteelBlue1, thick] [->] (8.8, -1) -- (12, -1) node[font=\tiny, above, align = right] {Génome \\ \emph{Acinetobacter}};
      %amorces
      \draw[Red3, ultra thick] (4, -1) -- (4.2, -1) node[above left, font=\tiny] {Amorce};
      \draw[Cerulean] (5, -1.2) -- (7, -1.2);
      % \draw[Gold1] (6, 0) -- (6.2, 0);
      \draw[Orange1] (7.0, -1.2) -- (8.8, -1.2);
      \draw[SteelBlue1, thick] [<-] (2, -1.2) -- (5, -1.2);
