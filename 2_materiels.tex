...
Les fréquences de transformations \(F\) ont été calculées de la façon suivante :
\begin{align}
  \begin{split}
    F &= \frac{\textrm{Nombre de transformants}}{\textrm{Nombre de cellules réceptrices totales}} \\
    F &= \frac{\textrm{Nombres de cellules résistantes à la kanamycine}}{\textrm{Nombre de cellules totales}}
  \end{split}
\end{align}
96 clones recombinants ont été isolés et incubés \SI{24}{\hour} à
