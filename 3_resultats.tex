...
La figure \ref{img:traces3} représente les zones de recombinaisons des
clones transformés par les donneurs GC, AT et AT/GC. Elles sont détaillées en
annexe \ref{sec:trac-de-conv}.
...
%   \end{tikzpicture}
%   \caption[Régions des recombinaisons des clones
%   transformés]{\label{img:traces3}\textbf{Régions de recombinaisons des clones
%       transformés.} \\
...
% TODO mettre annexe graphique pas d'alternance
...
% TODO calculer score de qualité moyen aux néomutations.
.
