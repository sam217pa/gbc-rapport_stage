    ...
    \begin{tikzpicture}[scale= 0.5]
      \draw [->] (0, 0) node[above]  {
        \begin{tabular}{ccccc|c}
          ...
          $N_{AT \rightarrow AT}$ & 1060 & -    & 375    & 404    & 1839           \\
          $N_{AT \rightarrow GC}$ & 613  & -    & 515    & 416    & 1544           \\
          \bottomrule
        \end{tabular}
      }
      -- ++(0, -1) node[below] {
        \begin{tabular}{ccc}
          \toprule
                                  & AT   & GC   \\
          \midrule
          Marqueurs non convertis & 1661 & 1839 \\
          Marqueurs convertis     & 1774 & 1544 \\
          \bottomrule
        \end{tabular}
